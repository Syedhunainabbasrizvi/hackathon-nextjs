...
export default function Footer() {
    return (
        <footer className="relative flex flex-col items-center space-y-6 px-10 w-full bg-white py-8">
            ...
            <div className="w-full flex flex-col lg:flex-row items-start justify-between gap-8">
                ...
                <div className="brand flex flex-col space-y-3 w-full lg:w-1/3">
                    <h1 className="text-blue-600 text-3xl font-bold text-center lg:text-left">
                        MORENT
                    </h1>
                ...
                {/* right-side */}
                <div className="links flex flex-wrap justify-center  lg:justify-end gap-12 w-full lg:w-2/3 mb-5">
                    <div className="link-group ">
                        <h2 className="font-semibold text-xl">About</h2>
                        <ul className="space-y-4 text-sm mt-4 text-gray-700">
                            <li>How it works</li>
                            <li>Featured</li>
                            <li>Partnership</li>
